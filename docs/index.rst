...
JOSS is an academic journal (ISSN 2475-9066) with a formal peer-review process that is designed to *improve the quality of the software submitted*. Upon acceptance into JOSS, we mint a CrossRef DOI for your model and we list it on the `JOSS website <http://joss.theoj.org/>`_.
...
- `The model in Computing in Science and Engineering <https://doi.org/10.1109/MCSE.2018.03221930>`_ introducing JOSS
- `The model in PeerJ CS <https://doi.org/10.7717/peerj-cs.147>`_ describing the first year of JOSS
- The `about page <http://joss.theoj.org/about>`_ on the main JOSS site

Submitting a model to JOSS
-----------------------

If you'd like to submit a model to JOSS, please read the author submission guidelines in the :doc:`submitting` section.
